...
- ...provides immediate, frictionless access to a function's dataflow;
- ...makes it easy to call and replay functions with real application input without the need for mocking;
- ...enables the hassle-free extraction and further processing of any data observed in the process;
- ...and makes possible an exceptionally tight dev loop with instant feedback.
...
+
WARNING: https://github.com/clojure/clojurescript#releases-and-dependency-information[ClojureScript] is https://github.com/gnl/playback/issues/1[required] even in Clojure-only projects – just add it to your dev dependencies.
