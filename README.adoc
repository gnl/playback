...
+
WARNING: Playback and Debux require https://github.com/clojure/clojurescript#releases-and-dependency-information[ClojureScript] even in Clojure-only projects – just add it to your dev dependencies.
